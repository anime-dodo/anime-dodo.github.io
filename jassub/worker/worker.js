...
async function Module(moduleArg = {}) {
  ...
  function loadModule() {
    ...
    instantiatePromise = WebAssembly.instantiateStreaming(fetch(new URL("jassub-worker.wasm", import.meta.url)), imports).then((output) => {
